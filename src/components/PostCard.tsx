...
function PostCard({
  ...
  return (
    <div className='group relative flex flex-col bg-fourth shadow-md p-2 h-full'>
      ...
      <div className='absolute bottom-0 left-0 w-full h-1/3 bg-secondary opacity-60 group-hover:opacity-90 group-hover:scale-[1.05] transition-all duration-500'></div>
